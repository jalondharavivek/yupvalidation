...
export function Main({ children }) {
  ...
  return (
    <>
      <Formdata.Provider value={{ datastate, setDatastate }}>
        {children}
      </Formdata.Provider>
    </>
  );
